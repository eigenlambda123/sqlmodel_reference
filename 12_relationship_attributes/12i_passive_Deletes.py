...
class Team(SQLModel, table=True):
    ...
    # Foreign key to Hero
    # passive_deletes="all" for making the Queries more efficient
    # when deleting a team, all heroes associated with that team will be set its team_id to NULL
    # This is useful for SQLite, which does not support ON DELETE SET NULL
...
class Hero(SQLModel, table=True):
    ...
    # Foreign key to Team
    # ondelete="SET NULL" ensures that when a team is deleted, its heroes' team_id is set to NULL
