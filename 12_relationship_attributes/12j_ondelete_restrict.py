...
class Hero(SQLModel, table=True):
    ...
    # Foreign key to Team
    # ondelete="RESTRICT" ensures that when a team is deleted, its heroes cannot be deleted
    # This is useful for preventing accidental deletions in SQLite, which does not support ON DELETE RESTRICT
